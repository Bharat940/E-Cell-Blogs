  ...
  return (
    <footer className="relative bg-slate-900 text-white py-16 px-6 md:px-16 lg:px-20 overflow-hidden  ">
      ...
      <div className="relative w-full max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:flex-wrap lg:flex-nowrap justify-between gap-y-12 lg:gap-x-12">
          {" "}
          {/* Flex container */}
          {/* Logo & Description */}
          <div className="flex-shrink-0 w-full md:w-[45%] lg:w-1/4 space-y-4 -mt-12">
            {" "}
          ...
          <div className="space-y-4 md:w-[calc(50%-1.5rem)]  lg:w-auto ">
            <div className="space-y-4 w-fit md:pl-16 lg:pl-0">
              {" "}
              {/* Adjusted width for responsiveness and w-auto for content fitting */}
          ...
          <div className="space-y-4 md:w-[calc(50%-1.5rem)] lg:w-auto">
            <div className="space-y-4 w-fit md:pl-16 lg:pl-0">
              ...
              <div className="space-y-2 text-gray-300 text-sm">
                ...
                <p>
                  Email:{" "}
                  <a href="mailto:support@ecellrgpv.com">
