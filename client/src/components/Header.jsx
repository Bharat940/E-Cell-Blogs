      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden lg:flex items-center space-x-1">
            ...
            >
              <button className="px-6 py-3 text-white font-medium hover:bg-blue-800/50 rounded-lg transition-all duration-200 hover:scale-105 flex items-center space-x-1">
              ...
              {isInitiativesOpen && (
                <div className="absolute top-full left-0 mt-2 w-56 bg-slate-800 rounded-xl shadow-2xl border border-blue-500/20 py-2 z-50 animate-in slide-in-from-top-2 duration-200">
                  <a
            ...
            >
              ...
              {isArchivesOpen && (
                <div className="absolute top-full left-0 mt-2 w-48 bg-slate-800 rounded-xl shadow-2xl border border-blue-500/20 py-2 z-50 animate-in slide-in-from-top-2 duration-200">
                  <a
